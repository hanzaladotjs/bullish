  ...
  return (
    ...
    <nav className="flex mt-2 mb-6 font-sans justify-between text-3xl text-gray-700 font-bold md:font-extrabold md:p-4 p-8 items-center">
      ...
      <div
        className={`${
          isOpen ? "flex" : "hidden"
        } md:flex flex-col md:flex-row md:mt-0 mt-45 mr-18 md:space-y-0 md:space-x-7 absolute text-center md:text-3xl text-2xl font-mono md:static top-20 right-0  md:w-auto md:bg-transparent bg-[#deb887] md:text-gray-700 md:p-0 z-10 shadow-md md:shadow-none`}
      >
